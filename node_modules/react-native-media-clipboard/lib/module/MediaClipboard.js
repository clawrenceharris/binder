...
if ( // @ts-ignore
process.env.NODE_ENV !== "production" && !MediaClipboard && Platform.OS === "ios") {
  console.log({
    MediaClipboard
  });
...
export const listenToClipboardChanges = listener => emitter && emitter.addListener("MediaClipboardChange", listener);
export const stopListeningToClipboardChanges = listener => emitter && emitter.removeListener("MediaClipboardChange", listener);
export const listenToClipboardRemove = listener => emitter && emitter.addListener("MediaClipboardRemove", listener);
export const stopListeningToClipboardRemove = listener => emitter && emitter.removeListener("MediaClipboardRemove", listener);
export const getClipboardContents = () => {
...
export const getClipboardMediaSource = () => {
  if (Platform.OS === "android") {
